...
export class QuadTree extends Tree{
    ...
    public nodeToShape(node: QuadNode, level: number, builder: SVGBuilder){
        if(node == null)
            return;
